...
function inferOperationChains(trains) {
  ...
  function nearestDeparture(arrival, pool, pass) {
    ...
    for (const d of pool) {
      ...
      if (pass.requireCompatibleTracks && !tracksCompatible(d.track, arrival.track)) continue;
  ...
  function nearestArrival(departure, pool, pass) {
    ...
    for (const a of pool) {
      ...
      if (pass.requireCompatibleTracks && !tracksCompatible(a.track, departure.track)) continue;
