...
// 実データ確認: Nootのある種別の列車は途中のある駅に一切stopsエントリを
...
// owner報告のNootのある実データ（詳細はNOTES.md参照）で発覚: 両者とも
...
function inferOperationChains(trains) {
  ...
  trains.forEach((train, index) => {
    ...
    // 1462→1443（-19）で、しかもその19件がNootのある駅・番線での正常な
    ...
    // も試したが撤回した（2026-08-08、issue #14）: Nootの一部の駅ではdepotWork
...
// （2026-07-15、project owner報告: Nootのある実データで、ある列車が3駅間
...
// （実例: Nootのある4本連続のチェーンで、末尾寄りの1本の出区記録にだけ
