...
// trains. `timesConfident` (per train) and `track` (per stop) are carried
// through as extra (data-model-additive) fields for a future consumer (e.g.
// a track-aware conflict check, issue #4) to flag low-confidence imports or
// read platform numbers; nothing else in TLINE currently reads either.
