...
function inferOperationChains(trains) {
  ...
  trains.forEach((train, index) => {
    ...
    if (depTimeToken && train.chainPrevIndex == null) departures.push({ index, stationIndex: first.stationIndex, track: first.track, time: timeToSeconds(depTimeToken) });
    if (arrTimeToken && train.chainNextIndex == null) arrivals.push({ index, stationIndex: last.stationIndex, track: last.track, time: timeToSeconds(arrTimeToken) });
  });
